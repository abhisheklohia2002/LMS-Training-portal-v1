...
export const useAssessmentsByCourse = (courseId?: number) =>
  useQuery({
    queryKey: courseId
      ? queryKeys.assessmentsByCourse(courseId)
      : ["assessments", "course", "missing"],
  ...
  return useMutation({
    ...
    onSuccess: (assessment) => {
      ...
      qc.invalidateQueries({
        queryKey: queryKeys.assessmentsByCourse(assessment.course_id),
      });
    },
  });
};
...
export const useCreateAssessmentRule = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => qc.invalidateQueries({ queryKey: ["assessment-rules"] }),
  });
};
...
export const useUpdateAssessment = () => {
  ...
  return useMutation({
    ...
    }) => api.assessments.update(id, payload),
